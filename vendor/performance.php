...
$totalEnq      = (int)$pdo->query("SELECT COUNT(*) FROM web_enquiries WHERE vendor_id=$uid")->fetchColumn();
$openEnq       = (int)$pdo->query("SELECT COUNT(*) FROM web_enquiries WHERE vendor_id=$uid AND status='new'")->fetchColumn();
$closedEnq     = (int)$pdo->query("SELECT COUNT(*) FROM web_enquiries WHERE vendor_id=$uid AND status='closed'")->fetchColumn();
$inProgEnq     = (int)$pdo->query("SELECT COUNT(*) FROM web_enquiries WHERE vendor_id=$uid AND status='contacted'")->fetchColumn();
